...
DEVICE_MODULES = [flowchem.mechwolf_components]
...
class DeviceGraph:
    ...
    def parse(self, config: Dict):
        ...
        for tube_config in config["connections"].values():
            ...
            tube = mw.Tube(length=tube_config["length"],
    ...
    def to_apparatus(self) -> mw.Apparatus:
        ...
        appa = mw.Apparatus(self.name, f"Apparatus auto-generated from flowchem DeviceGraph.")
